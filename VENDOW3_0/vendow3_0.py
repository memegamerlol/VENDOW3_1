...
def run_as_admin():
    ...
    if result <= 32:
        print("User declined elevation or another error occurred. Exiting.")
        sys.exit(1)
...
print("This is your main program logic.")   
...
# Example usage
change_wallpaper("files\does-anyone-know-the-actual-source-of-the-you-are-an-idiot-v0-ou7cy166ia7a1.webp")
...
def main():
    ...
    music_file="files\you-are-an-idiot.mp3"

    # winsound.PlaySound(os.path.join(sys._MEIPASS, "files/you-are-an-idiot.mp3"), winsound.SND_LOOP+winsound.SND_ASYNC)
...
def open_window():
    ...
    new_window.title("LOL")
    label = tk.Label(new_window, text="LOL")
    label.pack()
